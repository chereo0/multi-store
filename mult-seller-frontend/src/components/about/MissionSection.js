  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-20">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <div
          ref={leftRef}
          className="p-8 rounded-2xl bg-gradient-to-br from-indigo-50 to-purple-50 dark:bg-none"
        >
        ...
        <div
          ref={rightRef}
          className="p-8 rounded-2xl bg-white/60 dark:bg-gray-800/40 border border-gray-100 dark:border-gray-700"
        >
          <div className="text-cyan-500 font-semibold mb-2">Our Mission</div>
          <h3 className="text-3xl font-bold mb-4">
